...
librunner.update_rnn_runner2.argtypes = [c_void_p, c_int, c_int, POINTER(c_double), c_int, c_double, c_double, c_double, c_double, c_double]
...
class RNNRunner(object):
    ...
    def update(self, sequence, time_step, in_state, reg_count, rho_init, momentum, gamma_bp, gamma_top, beta):
        if in_state != None:
        ...
        self.librunner.update_rnn_runner2(self.runner, sequence, time_step, x,
                                          reg_count, rho_init, momentum, gamma_bp, gamma_top, beta)
